...
{
    if (detailed_Attri == "SCHOOL")
    {
        this->detailed_attribute = "SCHOOL";
        return true;
    }
    if (detailed_Attri == "OFFICE")
    {
        this->detailed_attribute = "OFFICE";
        return true;
    }
    if (detailed_Attri == "HOSPITAL")
    {
        this->detailed_attribute = "HOSPITAL";
        return true;
    }
    if (detailed_Attri == "SHOP")
    {
        this->detailed_attribute = "SHOP";
        return true;
    }

    if (detailed_Attri == "ESTATE")
    {
        this->detailed_attribute = "ESTATE";
        return true;
    }
    if (detailed_Attri == "APARTMENT")
    {
        this->detailed_attribute = "APARTMENT";
        return true;
    }
    if (detailed_Attri == "HOUSE")
    {
        this->detailed_attribute = "HOUSE";
        return true;
    }

    if (detailed_Attri == "MUSEUM")
    {
        this->detailed_attribute = "MUSEUM";
        return true;
    }
    if (detailed_Attri == "MONUMENT")
    {
        this->detailed_attribute = "MONUMENT";
        return true;
    }
    if (detailed_Attri == "PARK")
    {
        this->detailed_attribute = "PARK";
        return true;
    }

    if (detailed_Attri == "FACTORY")
    {
        this->detailed_attribute = "FACTORY";
        return true;
    }
    if (detailed_Attri == "AIRPORT")
    {
        this->detailed_attribute = "AIRPORT";
        return true;
    }
    if (detailed_Attri == "WAREHOUSE")
    {
        this->detailed_attribute = "WAREHOUSE";
        return true;
    }
    if (detailed_Attri == "TRAINSTATION")
    {
        this->detailed_attribute = "TRAINSTATION";
        return true;
    }

    if (detailed_Attri == "ROAD")
    {
        this->detailed_attribute = "ROAD";
        return true;
    }
    if (detailed_Attri == "BLANK")
    {
        this->detailed_attribute = "BLANK";
        return true;
    }
    if (detailed_Attri == "USED")
    {
        this->detailed_attribute = "USED";
        return true;
    }
...
bool CityGrid::addRoad(int start_row, int start_col, int length, string direction, string strname)
{
    ...
    if (start_row > grid_num_rows - 1)
    {
        start_row = grid_num_rows - 1;
    }
    if (end_row > grid_num_rows - 1)
    {
        end_row = grid_num_rows - 1;
    }
    if (start_col > grid_num_cols - 1)
    {
        start_col = grid_num_cols - 1;
    }
    if (end_col > grid_num_cols - 1)
    {
        end_col = grid_num_cols - 1;
    }
...
bool CityGrid::isEmptySpace(int uplr, int uplc, int uprc, int dlr)
{
    ...
    for (int i = uplr; i <= dlr; i++)
    {
        ...
        { // <= uprc to include the last column
